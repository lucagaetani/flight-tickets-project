  ...
  const handleConfirm = () => {
    ...
    arrayPassengerInfos.forEach((passenger, index) => {
        ...
        if (!passenger.surname) {
          ...
          delete newErrors[`surname-${index}`];
        }
        if (!passenger.email) {
                ...
                <Grid container spacing={2} columns={4}>
                  ...
                  <Grid item xs={4}>
                    <TextField
                      ...
                      fullWidth
                      onBlur={handleChange}
                      error={errors[`surname-${index}`] ? !!errors[`surname-${index}`] : !!errors[`empty-${index}`]}
                  ...
                  <Grid item xs={4}>
                    <TextField
                      ...
                      fullWidth
                      onBlur={handleChange}
                      error={errors[`email-${index}`] ? !!errors[`email-${index}`] : !!errors[`empty-${index}`]}
                  ...
                  <Grid item xs={4}>
                    <TextField
                      ...
                      fullWidth
                      onBlur={handleChange}
                      error={errors[`phone-${index}`] ? !!errors[`phone-${index}`] : !!errors[`empty-${index}`]}
                ...
                <Grid container spacing={2} columns={4}>
                  <Grid item xs={4}>
                    <TextField
                      ...
                      value={arrayPassengerInfos[index]?.airplaneLuggage || 0}
                  ...
                  <Grid item xs={4}>
                    <TextField
                      ...
                      value={arrayPassengerInfos[index]?.holdLuggage || 0}
                      onChange={handleChange}
